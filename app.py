...
# elif menu == "Future Glucose Prediction":
#     _m = get_models()
#     show_glucose_prediction(_m["glucose"], _m["glucose_sc"])
...
#             else:
#                 ans = str(result)
#             return ans.strip() or "I'm sorry, I couldn't find a relevant answer."
#         except Exception as e:
#             return f"⚠️ Error: {e}"
...
def gemini_generate(prompt: str, model_name: str = "gemini-1.5-flash",
    ...
    try:
        ...
        pass
    return f"⚠️ Could not generate summary: {last_error}"
...
if menu == "About":
    ...
    with col_b:
        ...
        **Technology Stack:**
        ...
        |---|---|
        | Disease Risk | XGBoost + MLP |
        | AI Summary / Lab | Gemini 1.5 Flash (dual-key) |
        | Symptom / BMI / Diet / Med | Groq llama-3.1-8b (dual-key) |
        | Chatbot | RAG + FAISS + LangChain |
        | Auth | bcrypt hashing |
        | API Monitoring | Admin Panel dashboard |
